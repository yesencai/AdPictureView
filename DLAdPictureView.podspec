...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of DLAdPictureView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/yesencai@163.com/DLAdPictureView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'yesencai@163.com' => 'yesencai@163.com' }
  s.source           = { :git => 'https://github.com/yesencai@163.com/DLAdPictureView.git', :tag => s.version.to_s }
